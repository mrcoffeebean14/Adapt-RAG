...
git clone https://github.com/mrcoffeebean14/Adapt-RAG.git
cd Adapt-RAG
...
A: Currently configured for Groq. You can modify `src/llms/groq.py` to use other providers.
